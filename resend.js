// 从环境变量中获取配置
const resendApiKey = RESEND_API_KEY;  // 从环境变量获取 Resend API 密钥
const fromEmail = FROM_EMAIL;  // 从环境变量获取发件人邮箱
const subject = SUBJECT;  // 从环境变量获取邮件主题
const body = BODY;  // 从环境变量获取邮件正文
